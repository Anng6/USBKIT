...
public class MsGadgetUtil {
    public static String MS_RO = "Read-Only";
    public static String MS_RW = "Read-Write";
    public static String MS_CD = "CD-Rom";
        ...
        public MsList(
            ...
            this.tool =
                    gadget.remoteFS.getFile(
                            String.format("%s/functions/%s/%s", gadget.gadgetPath, function, lun));
        }
    ...
    public MsList getMs(String fun, String lun) {
        ...
        return new MsList(gadget, fun, lun, path, mode, removable, nofua);
    }
